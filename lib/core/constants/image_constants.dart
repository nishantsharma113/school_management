...
String user = "${imagePath}user.png";

String home = "${imagePath}home_icon.svg";
String homeActive = "${imagePath}home_active_icon.svg";

String chat = "${imagePath}chat_icon.svg";
String chatActive = "${imagePath}chat_active_icon.svg";

String assignment = "${imagePath}assignment_icon.svg";
String assignmentActive = "${imagePath}assignment_active_icon.svg";
